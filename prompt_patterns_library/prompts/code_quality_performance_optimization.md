...
**Role / Perspective**: Act as a Performance Engineer with 8+ years of experience optimizing production systems.

**Task Description**: Optimize the provided [LANGUAGE] code for runtime latency and/or memory efficiency while preserving correct behavior and respecting the given constraints.
